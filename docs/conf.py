...
# [howto/manual]).
latex_documents = [
    ("index", "planemo.tex", "Planemo Documentation", "Galaxy Project and Community", "manual"),
]
...
man_pages = [("index", "planemo", "Planemo Documentation", ["Galaxy Project and Community"], 1)]
