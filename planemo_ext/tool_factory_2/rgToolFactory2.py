...
<citations>
    ...
    <citation type="doi">10.1093/bioinformatics/bts573</citation>
        ...
        with open(self.opts.script_path, 'r') as fh:
            rx = fh.readlines()
...
o.close()
        ...
        if self.opts.help_text:
            with open(self.opts.help_text, 'r') as fh:
                helptext = fh.readlines()
        ...
        if self.opts.citations:
            with open(self.opts.citations, 'r') as fh:
                citationstext = fh.read()
    ...
    def makeTooltar(self):
        ...
        with open(self.pyfile, 'r') as fh:
            pi = fh.readlines()  # our code becomes new tool wrapper (!) - first Galaxy worm
        notes += pi
